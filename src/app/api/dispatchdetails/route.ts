...
export async function GET(request: NextRequest) {
  try {
    ...
    // If user_id is not found in data, we'll show all data (handled by frontend)
    let userFilter = '';
...
${userFilter}
GROUP BY d.id, d.dispatch_code, d.item_name, d.school_id, d.center_id, d.truck_id, d.order_id, d.unit, d.total_qty, d.qty_dispatch, d.new_qty_dispatch, d.dispatch_return, d.bal_qty, d.status, d.created_at, d.updated_at, d.class_range, z.order_no, z.period, z.no_of_days, z.financial_year, s.schoolname, s.taluka_id, s.udaisno, s.user_id, ta.name, c.marathi_name, t.truckNo
